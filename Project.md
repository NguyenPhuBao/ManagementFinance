...
## 8. Tích Hợp Authentication (Client-app ↔ Backend)

> Hoàn thành: 2026-08-09

### 8.1 Kết nối thực tế Client-app với Backend
...
## 9. Tiến Độ Phát Triển & Kiến Trúc Core Offline-First (Cập nhật 2026-08-10)

### 9.1 Cấu Trúc Core Infrastructure (Client-app)
...
### 9.2 Chức Năng Quản Lý Ví (Wallet Feature - Plan 4)
...
### 9.3 Quy Chuẩn Đặc Tả Đồng Bộ Backend (Backend Sync Spec)
