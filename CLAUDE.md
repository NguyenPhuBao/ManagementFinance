...
| Đụng vào trang Phân tích | `docs/ANALYTICS_FEATURE.md` — lát **2a** (số thật thay số cứng) và **2b** (khối "Xu hướng 6 tháng") đều xong 2026-09-08; còn **2c** trang Xuất báo cáo vẫn số cứng. Ba thứ dễ vấp: `'transfer'` **không** phải thu/chi; "% ngân sách" mượn `watchBudgets(now: mốc)` và **phải lọc `isExpired`**; và font của bộ test rộng gấp đôi ngoài đời nên tiêu đề/nhãn phải co được (bẫy 4.4) |
...
```bash
# Test (chạy từ src/Client-app) — hiện 1599/1599 pass, ~120 giây
flutter test
