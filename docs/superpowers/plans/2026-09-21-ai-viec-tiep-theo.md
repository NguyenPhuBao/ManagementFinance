...
> **5/20** tham số · nội dung đúng **9/20**, **SAI 0** (bẫy 4.44 / 4.45 đóng) — mục **9.19**. Các
> đoạn dưới giữ làm lịch sử — chúng là bản viết khi nửa sau **chưa làm**.
