...
| RP09 | 408 | `` * `'Skipped'`: Người dùng chủ động bỏ qua kỳ hóa đơn này (không thanh toán và không tính nợ). `` | ⚠️ **Đề nghị sửa này nay THỪA** — khi đo (2026-09-10) `'Skipped'` chưa có ở đâu, nhưng backend đã thêm vào CHECK và `sync.validation.js:169` ngày 2026-09-11, và client dùng thật từ 2026-09-12. **Dòng gốc của `Rule_project.md` đúng, giữ nguyên.** | như RP08 | ✅ tự đóng |
