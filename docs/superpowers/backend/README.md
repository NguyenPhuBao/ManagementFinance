...
>
> Phần còn lại của tệp này giữ nguyên để tra cứu — mục 0 (thứ tự thi công chín
> bước) và mục 2 (trạng thái từng tài liệu) vẫn đúng, chỉ là các liên kết nay
> trỏ vào `CAN-LAM/`.
>
...
khỏi trạng thái chết. Nhóm C đắt nhất, cần migration, nhưng đừng bỏ.

> **Cập nhật 2026-09-07:** dòng cũ ở đây nói bước 9 là "thứ duy nhất còn chặn
> G10". **Không còn đúng** — G10 đã đóng mà backend không phải làm gì, xem
> bảng bên dưới mục 6.
