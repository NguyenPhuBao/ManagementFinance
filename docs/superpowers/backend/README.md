...
| 6 | [CATEGORY_GROUP_MEMBERSHIP_SYNC.md](./CAN-LAM/CATEGORY_GROUP_MEMBERSHIP_SYNC.md) | ⛔ Thứ **duy nhất** còn chặn G10: backend chưa có bảng/entity cho việc gán danh mục **mặc định** vào nhóm |
