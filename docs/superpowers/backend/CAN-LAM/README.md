...
> ⚠️ **Còn lại của đợt này (client ghi 2026-09-07):** cột **màu danh mục**
> (`CATEGORY_COLOUR_COLUMN.md`, mục 7b) **chưa có** trong đợt migration —
> bảng `category` vẫn 12 cột, không cột nào cho màu. Xin gộp vào đợt sau.
