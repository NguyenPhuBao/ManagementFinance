...
2026-09-07: **`CAN-LAM/`** giữ đúng phần **còn việc** (**mười một** mục — đếm bằng máy 2026-09-10 từ mục 2 của README ấy, sau khi thêm hai mục của đợt gộp `main`, gộp mục nới cột ví vào mục áp migration, rồi thêm mục bỏ `uq_wallet_saving_active`; dòng này từng ghi "bốn", "sáu", "tám" rồi "mười") và README
