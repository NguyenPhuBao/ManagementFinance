...
2. **Việc còn lại của backend: hai tài liệu** ở `docs/superpowers/backend/CAN-LAM/`
   ...
   **19** (`AUTH_PROFILE_COUNTDOWN.md`) chờ spec cưỡng chế đăng xuất được duyệt.
   ...
   gỡ chốt tạm một ví Tiết kiệm (G30), mở đồng bộ các cột hoá
