...
> → **12** đồng bộ `Auto_pay` chỉ sau 17 B → **13** G28 (người dùng chốt để sau) → *(mới, tách khỏi bước 8)* **14** `Period_end` — ân hạn, kỳ tính tiền tách khỏi hạn trả.
