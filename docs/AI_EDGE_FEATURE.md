...
lib/features/ai_edge/
  ...
  domain/   (lát 4b, 2026-09-23 — Task 1–4, CHƯA NỐI VÀO MÀN NÀO) hang_so_lieu.dart — HangSoLieu + KetQuaCongCu · goi_so_tra_cuu.dart — gói tích luỹ của bậc tool · cong_cu.dart — CongCu, KhaiBaoCongCu, bốn tên tool, kTranGoiCongCu · gac_cau.dart thêm DangTraCuu / KhongTraCuu · slm_prompt.dart thêm kPromptHeThongCongCu · (Task 5a) hang_hoa_don.dart — hàng theo tên cho tool hoá đơn
  data/     (lát 4b) phien_cong_cu.dart — giao diện phiên có tool + PhienCongCuGia · slm_runtime.dart thêm moPhien (bản thật _PhienThat — sập native với gói 1.7.0, chạy được từ 1.8.0, bẫy 4.33)
...
Móc tạm đã gỡ. ✅ **Task 5a** (hàm dựng hàng hoá đơn) xong cùng ngày (`21389ea`); 5b–5d và Task
6–9 cho phiên sau. Bẫy **4.33**.
