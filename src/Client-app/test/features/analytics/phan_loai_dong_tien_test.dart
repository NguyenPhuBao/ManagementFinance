/// Luật "một khoản thuộc phân loại nào", và phép gom ba lát của vòng tròn
/// "Cơ cấu dòng tiền".
///
...
/// tròn nói sai tỷ trọng mà không lỗi nào báo. Và ba lát phải RỜI NHAU: đếm
/// một khoản ở hai lát thì tổng vượt 100% và donut vẽ đè lên chính nó.
library;
...
void main() {
  ...
  group('theoPhanLoai', () {
    test('ba lát rời nhau, tổng tỉ lệ bằng 1', () {
      final ds = [
