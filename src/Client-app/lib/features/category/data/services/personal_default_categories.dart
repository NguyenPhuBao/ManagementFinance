...
///
/// ## Chặng hai (2026-09-05) đã bị ĐẢO LẠI ngày 2026-09-07
///
/// Năm hàng ấy từng được gộp ngược vào bộ mặc định của backend bằng
/// `foldIntoBackendDefaults()`. Hàm ấy nay **đã bị gỡ**: hướng đi đảo chiều —
/// mỗi tài khoản có **bản sao riêng** của toàn bộ bộ mặc định
/// (`DefaultCategorySeeder`), nên gộp ngược là chạy ngược chiều, và để cả hai
/// cùng chạy là một vòng lặp huỷ lẫn nhau.
///
...
class PersonalDefaultCategories {
  ...
  ///
  /// Không lọc theo tài khoản vì nơi gọi duy nhất — [convertLegacyRows] — chỉ
  /// đọc dữ liệu của chính máy này.
  Category? _findOwned(
    List<Category> owned,
